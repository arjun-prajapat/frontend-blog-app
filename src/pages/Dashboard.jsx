      ...
      {activeTab === "categories" && (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {categories.map((cat) => (
            <div
              key={cat.id}
              className="bg-card border rounded-xl p-6 flex justify-between items-start shadow-sm"
            >
              <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex justify-end gap-3 mt-6">
                <button
                  ...
                  className="px-4 py-2 rounded-md font-medium bg-secondary text-secondary-foreground"
                >
                  Cancel
                </button>
                <button
